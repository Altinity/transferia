...
replace github.com/jackc/pglogrepl => ./vendor_patched/github.com/jackc/pglogrepl

replace github.com/containerd/containerd => github.com/containerd/containerd v1.7.29

replace github.com/ClickHouse/clickhouse-go/v2 => github.com/ClickHouse/clickhouse-go/v2 v2.33.1
