...
var (
	...
	source       = *pgrecipe.RecipeSource(pgrecipe.WithInitDir(helpers.RepoPath("tests", "e2e-core", "pg2ch", "replication", "dump", "pg")), pgrecipe.WithPrefix(""), pgrecipe.WithoutPgDump())
	target       = *chrecipe.MustTarget(chrecipe.WithInitDir(helpers.RepoPath("tests", "e2e-core", "pg2ch", "replication", "dump", "ch")), chrecipe.WithDatabase(databaseName))
)
